...
object TextToSpeechInstance {
    ...
    var speechMap:LinkedHashMap<Int,String> = LinkedHashMap()
    private var isStart:Boolean = false
    var speechStringQueue:ArrayDeque<String> = ArrayDeque()
    var ttsWordListener:TextToSpeechListener?=null

    public var speechQueue:ArrayDeque<Pair<String,String>> = ArrayDeque()
    ...
    fun speak(word: String,startIndex:Int) {

        speechMap.put(startIndex,word)

//        this.speechStringBuilder = stringBuilder
//        speechQueue.add(Pair(startIndex,endIndex))
...
//            }
    ...
    fun speak(stringBuilder: StringBuilder) {
    ...
    fun speak(stringBuilder: MySpannableStringBuilder,startIndex:Int,endIndex:Int) {
        ...
        if (isReady) {
            ...
            //tts.addSpeech(String(),Uri())

            tts!!.speak(stringBuilder,TextToSpeech.QUEUE_FLUSH,null,startIndex.toString())
            ttsWordListener!!.onWordSpoken(startIndex,endIndex,stringBuilder.substring(startIndex,endIndex))
...
//            }
    ...
    interface TextToSpeechListener{
        ...
        fun onWordSpoken(startIndex:Int,endIndex: Int,word:String)
    }
